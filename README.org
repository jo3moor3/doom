...
* System
** Setup
Deactivating and initializing certain things, and setting up "important" keybindings.
#+begin_src  elisp
...
Tokyo-Night is also a cool one (originally a vscode theme).
...
* ORG
** Setup
Important configurations, [[https://github.com/abo-abo/org-download][org-download]], and [[https://github.com/yilkalargaw/org-auto-tangle][org-auto-tangle]] (same as :config +literate in Doom/init.el).
#+begin_src elisp
(after! org
...
#+end_src
** LaTeX
I use latex solely as a method to render math in org.
#+begin_src elisp
